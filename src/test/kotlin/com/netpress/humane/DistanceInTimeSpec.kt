...
class DistanceInTimeSpec : DescribeSpec({
    describe("Humane.distanceInTime") {
        val base = Instant.parse("2026-07-08T12:00:00Z")

        describe("with no options (the recommended defaults: approximate true, includeSeconds false -- matching ActionView's own defaults)") {
            var at = base
